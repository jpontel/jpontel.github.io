...
function StyledDiv({message}: { message: string }) {
    return (
        <div className={'w-[300px] border border-slate-400 h-[100px] font-bold font-baijamjuree text-white bg-zinc-800 rounded-lg p-6 text-center items-center'}>
            {message}
        </div>
    );
}
...
export default function GetInTouchPage() {
    ...
    return (
        <Fragment>
            ...
            <div
                className={'w-full h-[80vh] flex flex-col text-white lg:px-[250px] lg:pt-[100px] font-baijamjuree '}>
                <div className={'w-full h-full inline-flex'}>
                    <div className={'w-full h-full flex flex-col'}>
                        ...
                        <p className={'text-[15px] w-2/3 leading-8'}>
                            Have a project in your mind? Looking to partner or work together? Reach out through
                            the form
                            and
