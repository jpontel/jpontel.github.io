        ...
        <div
            ...
            <div className={'w-full h-full flex flex-col xsm:gap-2 md:gap-8 justify-center items-center text-start'}>
                <div className={'flex flex-col w-full'}>
                    ...
                    <div className={'text-left xsm:text-[15px] leading-8 md:text-[18px] xsm:w-full md:w-2/3 text-white'}>
            ...
            <div className={'flex flex-col w-full h-full items-center justify-center font-baijamjuree'}>
                ...
                <div className={'w-full h-full flex items-center justify-center mt-12 font-baijamjuree'}>
                    <div className={'w-full h-[400px] styled-background rounded-b-[50px] flex flex-col items-start font-baijamjuree font-bold text-center py-12'}>
                        <span className={'w-full h-full xsm:p-2 md:p-0 flex flex-col items-center justify-center xsm:text-[45px] md:text-[60px] text-white'}>
